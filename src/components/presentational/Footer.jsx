    ...
    <footer className="bg-brand-black border-t border-brand-charcoal">
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
          ...
          {/* Social */}
          <div>
            <p className="section-label mb-6">{t('footer.followUs')}</p>
            <div className="flex gap-5">
              <a
                href={SOCIAL_LINKS.instagram}
                target="_blank"
                rel="noopener noreferrer"
                className="text-brand-muted hover:text-brand-bronze transition-colors duration-300"
            ...
            <p className="text-brand-muted text-xs font-body mt-8">
              info@prismvisuals.hu
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 pt-6 border-t border-brand-charcoal flex flex-col md:flex-row justify-between items-center gap-3">
          ...
          <p className="text-brand-muted/50 text-xs font-body font-light">
